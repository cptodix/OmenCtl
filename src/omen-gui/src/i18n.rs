...
fn translate_tr(key: &'static str) -> &'static str {
    match key {
        ...
        "hybrid_desc" => "Günlük kullanımda dahili Intel GPU, oyunlarda harici RTX 4050 kullanılır.",
        "discrete_title" => "Discrete",
        "discrete_mode" => "Yalnızca Harici GPU (dGPU)",
        "discrete_desc" => "Dahili GPU kapatılır. Tüm ekran çıkışları doğrudan RTX 4050'ye bağlanır.",
...
fn translate_en(key: &'static str) -> &'static str {
    match key {
        ...
        "hybrid_desc" => "Uses integrated Intel GPU for daily tasks and discrete RTX 4050 for heavy games.",
        "discrete_title" => "Discrete",
        "discrete_mode" => "Discrete GPU Only (dGPU)",
        "discrete_desc" => "Integrated GPU is disabled. All displays connect directly to RTX 4050.",
        ...
        "troubleshooting_desc" => "Hardware reports and GitHub Issue builder for unsupported devices.",
